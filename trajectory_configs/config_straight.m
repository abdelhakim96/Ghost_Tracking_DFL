...
quad_initial.angle = [0; 0; 0.1];             % Initial Euler angles (rad) [roll, pitch, yaw]
...
dfl_gains.c0 = 3250.0;  % Position gain
dfl_gains.c1 = 3400.0;  % Velocity gain
...
dfl_gains.c_theta = 5000.0;    % Proportional gain for gimbal pitch
