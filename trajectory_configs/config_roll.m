...
dfl_gains.c0 = 11150.0;  % Position gain
dfl_gains.c1 = 11140.0;  % Velocity gain
dfl_gains.c2 = 550.0;   % Acceleration gain
dfl_gains.c3 = 150.0;    % Jerk gain
dfl_gains.c4 = 5.0;   % Yaw gain
dfl_gains.c5 = 5.00;    % Yaw rate gain

% Gimbal Gains
dfl_gains.c_phi = 61500.0      % Proportional gain for gimbal roll
dfl_gains.c_theta = 61700.0;    % Proportional gain for gimbal pitch
